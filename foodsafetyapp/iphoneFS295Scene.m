...
@implementation iphoneFS295Scene
...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        SKSpriteNode *top = [[SKSpriteNode alloc] initWithColor:[SKColor colorWithRed:65/255.0 green:86.0/255.0 blue:161.0/255.0 alpha:1.0] size:CGSizeMake(self.size.width, 90.0)];
        ...
        aLetter.position = CGPointMake(self.size.width*.5, self.size.height-64.0);
